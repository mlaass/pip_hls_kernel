...
if {[file isfile pip_kernel.autotvin.dat]} {
	file delete -force pip_kernel.autotvin.dat
}

if {[file isfile pip_kernel.autotvout.dat]} {
	file delete -force pip_kernel.autotvout.dat
}
