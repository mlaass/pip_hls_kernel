...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.pip_kernel.autotvin_gmem.dat"
         "c.pip_kernel.autotvin_points.dat"
         "c.pip_kernel.autotvin_edges.dat"
         "c.pip_kernel.autotvin_strm_len.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.pip_kernel.autotvout_out_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
