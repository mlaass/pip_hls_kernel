...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "pip_kernel.autotvin.dat"
	set constFileTvOut       "pip_kernel.autotvout.dat"
	set constFileHdlTvIn     "pip_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "pip_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
