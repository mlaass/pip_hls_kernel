...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("points_TDATA", 24, hls_in, 2, "axis", "in_data", 1),
	Port_Property("points_TVALID", 1, hls_in, 2, "axis", "in_vld", 1),
	Port_Property("points_TREADY", 1, hls_out, 2, "axis", "in_acc", 1),
